...
## Environments
- Preview: https://main--eds-example--Asamad-al.aem.page/
- Live: https://main--eds-example--Asamad-al.aem.live/
...
1. Open the `eds-example` directory in your favorite IDE and start coding :)
